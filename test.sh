...
declare -A EXPECTED=(
    ...
    [clone_to_uninit_uaf]="use_after_free"
    ...
    [slice_disjoint_unchecked]="disjoint_unchecked_mut"
    [slice_disjoint_unchecked_safe]=""
    ...
    [env_set_var_concurrent]="env_set_var"
    [ptr_swap]="ptr_swap"
    ...
    [naked_fn]="naked_fn"
    [hashmap_disjoint_unchecked]="disjoint_unchecked_mut"
    ...
    [volatile_intrinsics_uaf]="use_after_free"
    ...
    [heapless_unchecked_safe]=""
    [not_nan_unchecked]="nonzero_new_unchecked"
    [not_nan_unchecked_safe]=""
    [nix_fork]="nix_fork"
    [spin_unsafe]="lock_api_unsafe"
    [triomphe_unchecked]="triomphe_unchecked"
    [nalgebra_unchecked]="nalgebra_unchecked"
    [zerocopy_unchecked]="zerocopy_unchecked"
    [regex_automata_unchecked]="from_bytes_unchecked"
    ...
    [hashbrown_map_unchecked_safe]=""
    [slab_unchecked]="disjoint_unchecked_mut"
    [slab_unchecked_safe]=""
    [slotmap_unchecked]="disjoint_unchecked_mut"
    [slotmap_unchecked_safe]=""
    [psm_unsafe]="psm_unsafe"
    [arrayvec_unchecked]="arrayvec_unchecked"
    [arrayvec_unchecked_safe]=""
    ...
    [alloc_double_free]="ownership_double_free"
    [raw_realloc_uaf]="ownership_double_free"
